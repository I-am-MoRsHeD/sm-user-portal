                ...
                <div className='bg-white w-full space-y-4 flex flex-col items-center py-8 rounded-xl'>
                    ...
                    <div className="flex flex-row items-end text-xs lg:text-base w-full px-5">
                        <div className='w-full '>
                            ...
                            <input
                                className='w-full px-3 py-2.5 border border-gray-300 text-xs outline-0 rounded-l-full'
                                type="text"
                                name="qrcode"
                                placeholder='Transaction ID'
                            />
                        </div>
                        <div className='border-y border-gray-300 w-12 h-[37px] flex justify-center items-center'>
                        ...
                        <div className='border border-gray-300 w-12 h-[37px] p-4 flex justify-center items-center rounded-r-full bg-[#723EEB]'>
                    ...
                    <div className="flex flex-row items-end text-xs lg:text-base w-full px-5">
                        <div className='w-full '>
                            ...
                            <input
                                className='w-full px-3 py-2.5 border border-gray-300 text-xs outline-0 rounded-l-full font-semibold placeholder:text-[#733ebc]'
                                type="text"
                                name="qrcode"
                    ...
                    <div className='flex flex-row gap-5 w-full px-5'>
                        <Link href={"/send-money"} className='w-[50%]'>
