    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-20 w-full bg-gradient-to-tl from-cyan-200 to-pink-200 h-auto text-black'>
                <div className={`h-screen ${isNavOpen ? 'col-span-2 md:col-span-4 lg:col-span-3 5xl:col-span-2' : 'col-span-2 md:col-span-1'} w-full bg-white transition-all duration-300 overflow-auto`}>
                    <TheSidebar />
                </div>
                <div className={`h-screen ${isNavOpen ? 'col-span-18 md:col-span-16 lg:col-span-17 5xl:col-span-18' : 'col-span-18 md:col-span-19'} transition-all duration-300 w-full`}>
