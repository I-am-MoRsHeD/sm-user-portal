      ...
      <div className="flex justify-between items-center py-4 flex-wrap">
        ...
        <div className='flex items-center flex-wrap justify-end gap-1 lg:gap-4'>
          ...
          <div>
            ...
            <div className={`${profileDropdown ? 'visible top-16 p-2 bg-white opacity-100 px-4' : 'invisible top-12 opacity-0'} absolute mx-auto right-2 w-28 z-50 rounded border duration-300 cursor-pointer divide-y`}>
