    ...
    return (
        <div>
            <div className={`fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-[999] ${isOpen ? 'opacity-1 visible' : 'invisible opacity-0'}`}>
                <div className={`bg-white rounded shadow-lg overflow-hidden w-[95%] max-w-96 lg:w-full overflow-y-auto transition-all duration-500 ease-in-out absolute top-5 ${isOpen ? 'opacity-1 translate-y-0' : '-translate-y-20 opacity-0'}`}>
