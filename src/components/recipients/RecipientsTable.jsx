...
const RecipientsTable = ({ data }) => {
    const { name, email, country, city_state, phone, method, account } = data;
    return (
        <>
            <div className='bg-gray-100 rounded-2xl p-4 mt-10'>
                <div className=''>
                    ...
                    <p className='border-b border-black flex flex-row justify-between items-center text-xs pb-2 '>
                        <div className='flex flex-row gap-3 items-center'>
                            <div className='border-[1.5px] border-[#723EEB] flex justify-center items-center w-6 h-6 rounded-full'>
                                <svg width="11" height="14" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='border-b border-black flex flex-row justify-between items-center py-3 text-xs'>
                        <div className='flex flex-row gap-3 items-center'>
                            <div className='border-[1.5px] border-[#723EEB] flex justify-center items-center w-6 h-6 rounded-full'>
                                <svg width="11" height="12" viewBox="00 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='border-b border-black flex flex-row justify-between items-center py-3 text-xs'>
                        <div className='flex flex-row gap-3 items-center'>
                            <div className='border-[1.5px] border-[#723EEB] flex justify-center items-center w-6 h-6 rounded-full'>
                                <svg className='' width="13" height="13" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
