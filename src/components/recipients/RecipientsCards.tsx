...
import { recipientsData, RecipientsDataType } from "@/utils/data/recipientsData";
    ...
    return (
        <>
            {recipients.map((data : any) => (
                <div
                    key={String(data.id)} // Convert id to string if it's a number
                        ...
                        <div className="flex flex-row gap-3 lg:gap-4 items-start">
                            ...
                            <div>
                                <h3 className="text-[10px] lg:text-base font-semibold text-[#723EEB]">
                                    ID: {String(data.recipientsId)} {/* Convert recipientsId to string */}
                                </h3>
                            </div>
                        </div>
