                            ...
                            <tbody className="divide-y divide-gray-300">
                                {transactions?.map((transaction: any) => (
                                    <React.Fragment key={transaction?.id}>
                                        ...
                                        >
                                            <td className="px-4 py-2 text-sm text-gray-700">{new Date(transaction?.createdAt).toLocaleDateString()}</td>
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-700">{transaction?.amount}{transaction?.sendingCurrency?.code}</td>
                                            <td className="px-4 py-2 text-sm text-gray-700">{transaction?.recipientGet}{transaction?.receivingCurrency?.code}</td>
                                            ...
                                            <td className="px-4 py-2 text-sm">
                                                {transaction?.receipt === 'Download' ? (
                                                    ...
                                                    <span className="text-gray-700">No Receipt Found</span>
                                                )}
                                            </td>
                                        </tr>
