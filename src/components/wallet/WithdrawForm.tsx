    ...
    return (
        <>
            ...
            <div className='mt-1 mb-5 font-semibold'>
                <h2 className="">$ <span className='text-5xl'>00.0</span>USD</h2>
            </div>
            <div className='space-y-5'>
                ...
                <div className='w-full mx-auto pb-5'>
                    <input className='w-full bg-[#ea5455] text-white p-2 rounded text-[10px]' type="submit" value="Confirm Withdraw" />
                </div>
            </div>
        </>
    );
